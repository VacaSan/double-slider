...
var DoubleSlider = function () {
  ...
  _createClass(DoubleSlider, [{
    ...
    value: function _dispatch(typeArg) {
      var evt = new CustomEvent(typeArg, { bubbles: true, detail: this.value });
